...
import com.kirkkt.javatests.tax.forms.fillable.federal.F1040TaxYear2014Test;
...
public class TestRunner {
  ...
  private TestRunner() {
    ImmutableList<FormTest> formTests = ImmutableList.<FormTest>builder()
        ...
        // fillable forms federal
        .add(new F1040TaxYear2014Test())
        .add(new F1040ScheduleATaxYear2014Test())
        .add(new F1040ScheduleBTaxYear2014Test())
        .add(new F6251TaxYear2014Test())
